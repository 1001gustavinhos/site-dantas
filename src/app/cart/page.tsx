    ...
    return (
      <MainLayout>
        <div className="text-center py-12">
          ...
          <h1 className="text-2xl font-page-title font-semibold mb-4">
  ...
  return (
    <MainLayout>
      <section className="py-8">
        <h1 className="text-3xl font-page-title font-semibold mb-8 text-primary">
          {texts.yourCart}
        </h1>
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <Card>
              <CardHeader>
                <CardTitle className="font-page-title font-semibold">
                  {texts.orderSummary}
                </CardTitle>
              </CardHeader>
