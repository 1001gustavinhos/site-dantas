...
export default function OrderPlacedPage() {
  ...
  if (!isClient || !whatsappUrl || !whatsappMessage) {
    return (
      <LoadingSpinner text={texts.loadingOrderDetails} fullPageLayout={true} />
    );
  }
      ...
      <section className="py-8 max-w-lg mx-auto text-center">
        <Card className="shadow-lg">
          ...
          <CardContent className="space-y-6">
            ...
            <div>
              <h3 className="text-lg font-page-title font-semibold mb-2 text-left">
                {texts.whatsappMessageLabel}
              </h3>
              <Textarea
                value={whatsappMessage}
                readOnly
                rows={8}
                className="resize-none bg-muted/50 mb-2"
              />
              <Button
